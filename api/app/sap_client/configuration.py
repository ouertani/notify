...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="https://livelink.sapmobileservices.com/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("app.sap_client")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://livelink.sapmobileservices.com/api",
