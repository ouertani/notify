...
<Parameters>
  ...
  <Parameter name="source_number" kind="string">The number the message was sent from (the original recipient’s number)</Parameter>
  <Parameter name="destination_number" kind="string">The number the message was sent to (your service’s number)</Parameter>
...
A simple callback handler might look something like this:
